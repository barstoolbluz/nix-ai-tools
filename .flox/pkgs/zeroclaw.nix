...
let
  ...
  sources = {
    "x86_64-linux" = "sha256-i8gnao2Prvs+SoJPM4dpKedGb2Mu58U2OTY2ihry5Pc=";
    "aarch64-linux" = "sha256-CxGX8dgCQ+XHSLY6VQzG38N+QHxNFfcpsyMkup/kwqw=";
    "aarch64-darwin" = "sha256-xdvz5+GGmlHIiBcXRvJuoOgvtEpZPT7RqoRW8VsSMl0=";
  };
in
stdenv.mkDerivation {
  pname = "zeroclaw";
