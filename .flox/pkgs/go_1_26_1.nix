...
let
  ...
  sources = {
    "x86_64-linux" = {
      ...
      hash = "sha256-Ax8Ijl2VW6uGV+3ietTjvFt8G6KB8F8kW8wwTzJ8mHo=";
    };
    "aarch64-linux" = {
      url = "https://go.dev/dl/go${version}.linux-arm64.tar.gz";
      hash = "sha256-opBYHP5P4o3dc33eMJXz2+t/LkBlyrTq5E38U7dgwvc=";
    };
    "x86_64-darwin" = {
      url = "https://go.dev/dl/go${version}.darwin-amd64.tar.gz";
      hash = "sha256-ZXc9qy+MxM0j2Tum0KgF3hUMoLeDeIeSkr4LkDuM3Qg=";
    };
    "aarch64-darwin" = {
